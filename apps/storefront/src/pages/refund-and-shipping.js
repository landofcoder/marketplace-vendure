...
const RefundAndShipping = () => {
    return (
        <LayoutFive>
            {/* breadcrumb */}
            <BreadcrumbOne
                pageTitle="Storeofapp Refund and Shipping"
            ...
            >
                <ul className="breadcrumb__list">
                    ...
                    <li>Storeofapp Refund and Shipping</li>
                </ul>
            </BreadcrumbOne>
                    ...
                    <Row className="justify-content-center">
                            ...
                            <div className="bg-color--grey my-account-area__content">
                                <div className="about-page-text space-mb--30 mt-0">
                                    ...
                                    <p>
                                        ...
                                        on Storeofapp website order purchased:
                                    </p>
                                </div>
                                ...
                                <div className="icon-box icon-box--feature-icon space-mb--35">
                                    ...
                                    <div className="icon-box--feature-icon__content">
                                        ...
                                        <p>
                                            ...
                                            Please go through the below International customers refund policy on Storeofapp website order purchased.
                                        </p>
                        ...
                        <Col xl={5} lg={6} className="offset-lg-1 bg-color--grey my-account-area__content">
                            <div className="about-page-text space-mb--30 mt-0">
                                ...
                                <p>
                                    Storeofapp offers various Shipping options. Here's a look at what's available:
                                </p>
                            </div>
