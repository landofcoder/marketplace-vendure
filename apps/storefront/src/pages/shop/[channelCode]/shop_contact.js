  ...
  return (
    <LayoutFive aboutOverlay={false}>
      ...
      <div className="shop-style">
        <Tab.Container defaultActiveKey="shop_contact">
        <Nav
            variant="pills"
          ...
          <Tab.Content>
            <Tab.Pane eventKey="shop_contact">
              <ShopContact shop={vendorInfo} customer={currentCustomer} />
            </Tab.Pane>
          </Tab.Content>
        </Tab.Container>
      </div>
