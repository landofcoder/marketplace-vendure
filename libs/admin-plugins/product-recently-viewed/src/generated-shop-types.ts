 ...
 **/
  ...
  setCustomerToVendor?: Maybe<Vendor>,
  ...
  createMyEntity?: Maybe<MyEntity>,
  updateMyEntity?: Maybe<MyEntity>,
  deleteMyEntity?: Maybe<MyEntity>,
};
...
export type MutationSetCustomerToVendorArgs = {
  input?: Maybe<SetCustomerTovendorInput>
};
...
export type MutationCreateMyEntityArgs = {
  input: MyEntityInput
};


export type MutationUpdateMyEntityArgs = {
  input: MyEntityUpdateInput
};


export type MutationDeleteMyEntityArgs = {
  input: MyEntityDeleteInput
};
...
export type MyEntityDeleteInput = {
  id: Scalars['ID'],
};

export type MyEntityInput = {
  firstName: Scalars['String'],
  lastName: Scalars['String'],
  age: Scalars['Int'],
};
 ...
 **/
  ...
  myQueryProduct?: Maybe<ProductList>,
  getMyEntity?: Maybe<Array<Maybe<MyEntity>>>,
};
...
export type QueryMyQueryProductArgs = {
  options?: Maybe<ProductListOptions>
};
