...
export namespace CreateVendor {
  ...
  export type CreateVendor = (NonNullable<CreateVendorMutation['createVendor']>);
}

export namespace CreateVendorInfo {
  export type Variables = CreateVendorInfoMutationVariables;
  export type Mutation = CreateVendorInfoMutation;
  export type CreateVendorInfo = (NonNullable<CreateVendorInfoMutation['createVendorInfo']>);
}

export namespace CreateVendorBank {
  export type Variables = CreateVendorBankMutationVariables;
  export type Mutation = CreateVendorBankMutation;
  export type CreateVendorBank = (NonNullable<CreateVendorBankMutation['createVendorBank']>);
}

export namespace CreateVendorContact {
  export type Variables = CreateVendorContactMutationVariables;
  export type Mutation = CreateVendorContactMutation;
  export type CreateVendorContact = (NonNullable<CreateVendorContactMutation['createVendorContact']>);
}

export namespace CreateVendorMarketingContact {
  export type Variables = CreateVendorMarketingContactMutationVariables;
  export type Mutation = CreateVendorMarketingContactMutation;
  export type CreateVendorMarketingContact = (NonNullable<CreateVendorMarketingContactMutation['createVendorMarketingContact']>);
}

export namespace VendorDetail {
  export type Fragment = VendorDetailFragment;
  export type User = (NonNullable<VendorDetailFragment['user']>);
  export type Roles = NonNullable<(NonNullable<(NonNullable<VendorDetailFragment['user']>)['roles']>)[number]>;
  export type Banks = NonNullable<(NonNullable<VendorDetailFragment['banks']>)[number]>;
  export type Contacts = NonNullable<(NonNullable<VendorDetailFragment['contacts']>)[number]>;
  export type Info = NonNullable<(NonNullable<VendorDetailFragment['info']>)[number]>;
  export type Marketing = NonNullable<(NonNullable<VendorDetailFragment['marketing']>)[number]>;
}

export namespace GetCurrentVendor {
  export type Variables = GetCurrentVendorQueryVariables;
  export type Query = GetCurrentVendorQuery;
  export type ActiveVendor = (NonNullable<GetCurrentVendorQuery['activeVendor']>);
}

export namespace GetVendorById {
  export type Variables = GetVendorByIdQueryVariables;
  export type Query = GetVendorByIdQuery;
  export type GetVendorById = (NonNullable<GetVendorByIdQuery['getVendorByID']>);
}
...
export namespace UpdateVendor {
  ...
  export type UpdateVendor = (NonNullable<UpdateVendorMutation['updateVendor']>);
}

export namespace UpdateVendorInfo {
  export type Variables = UpdateVendorInfoMutationVariables;
  export type Mutation = UpdateVendorInfoMutation;
  export type UpdateVendorInfo = (NonNullable<UpdateVendorInfoMutation['updateVendorInfo']>);
}

export namespace UpdateVendorBank {
  export type Variables = UpdateVendorBankMutationVariables;
  export type Mutation = UpdateVendorBankMutation;
  export type UpdateVendorBank = (NonNullable<UpdateVendorBankMutation['updateVendorBank']>);
}

export namespace UpdateVendorContact {
  export type Variables = UpdateVendorContactMutationVariables;
  export type Mutation = UpdateVendorContactMutation;
  export type UpdateVendorContact = (NonNullable<UpdateVendorContactMutation['updateVendorContact']>);
}

export namespace UpdateVendorMaketingContact {
  export type Variables = UpdateVendorMaketingContactMutationVariables;
  export type Mutation = UpdateVendorMaketingContactMutation;
  export type UpdateVendorMaketingContact = (NonNullable<UpdateVendorMaketingContactMutation['updateVendorMaketingContact']>);
}
...
export namespace VendorBank {
  export type Fragment = VendorBankFragment;
}

export namespace VendorContact {
  export type Fragment = VendorContactFragment;
}

export namespace VendorInfo {
  export type Fragment = VendorInfoFragment;
}

export namespace VendorMarketingContact {
  export type Fragment = VendorMarketingContactFragment;
}

export namespace GetVendorsList {
  export type Variables = GetVendorsListQueryVariables;
  export type Query = GetVendorsListQuery;
  export type Vendors = (NonNullable<GetVendorsListQuery['vendors']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetVendorsListQuery['vendors']>)['items']>)[number]>;
}
...
export namespace DeleteVendor {
  ...
  export type DeleteVendor = (NonNullable<DeleteVendorMutation['deleteVendor']>);
}
...
export type CreateVendorInfoMutationVariables = Exact<{
  input: VendorInfoInput;
}>;


export type CreateVendorInfoMutation = (
  { __typename?: 'Mutation' }
  & { createVendorInfo?: Maybe<(
    { __typename?: 'VendorInfo' }
    & VendorInfoFragment
  )> }
);

export type CreateVendorBankMutationVariables = Exact<{
  input: VendorBankInput;
}>;


export type CreateVendorBankMutation = (
  { __typename?: 'Mutation' }
  & { createVendorBank?: Maybe<(
    { __typename?: 'VendorBank' }
    & VendorBankFragment
  )> }
);
...
export type CreateVendorContactMutation = (
  { __typename?: 'Mutation' }
  & { createVendorContact?: Maybe<(
    { __typename?: 'VendorContact' }
    & VendorContactFragment
  )> }
);

export type CreateVendorMarketingContactMutationVariables = Exact<{
  input: VendorMarketingContactInput;
}>;


export type CreateVendorMarketingContactMutation = (
  { __typename?: 'Mutation' }
  & { createVendorMarketingContact?: Maybe<(
    { __typename?: 'VendorMarketingContact' }
    & VendorMarketingContactFragment
  )> }
);

export type VendorDetailFragment = (
  { __typename?: 'Vendor' }
  & { user: (
    { __typename?: 'User' }
    & { roles: Array<(
...
export type GetCurrentVendorQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentVendorQuery = (
  { __typename?: 'Query' }
  & { activeVendor?: Maybe<(
    { __typename?: 'Vendor' }
...
export type UpdateVendorInfoMutation = (
  { __typename?: 'Mutation' }
  & { updateVendorInfo?: Maybe<(
    { __typename?: 'VendorInfo' }
    & VendorInfoFragment
  )> }
);

export type UpdateVendorBankMutationVariables = Exact<{
  input: UpdateVendorBankInput;
}>;


export type UpdateVendorBankMutation = (
  { __typename?: 'Mutation' }
  & { updateVendorBank?: Maybe<(
    { __typename?: 'VendorBank' }
    & VendorBankFragment
  )> }
);
...
export type UpdateVendorContactMutation = (
  { __typename?: 'Mutation' }
  & { updateVendorContact?: Maybe<(
    { __typename?: 'VendorContact' }
    & VendorContactFragment
  )> }
);

export type UpdateVendorMaketingContactMutationVariables = Exact<{
  input: UpdateVendorMarketingInput;
}>;


export type UpdateVendorMaketingContactMutation = (
  { __typename?: 'Mutation' }
  & { updateVendorMaketingContact?: Maybe<(
    { __typename?: 'VendorMarketingContact' }
    & VendorMarketingContactFragment
  )> }
);
...
export type VendorFragment = (
  { __typename?: 'Vendor' }
  & Pick<Vendor, 'id' | 'firstName' | 'lastName' | 'email' | 'phone' | 'GSTINID' | 'state' | 'ownerName' | 'ownerEmail' | 'verified'>
);

export type VendorBankFragment = (
  { __typename?: 'VendorBank' }
  & Pick<VendorBank, 'id' | 'account' | 'code' | 'address' | 'type' | 'isCheck'>
);

export type VendorContactFragment = (
  { __typename?: 'VendorContact' }
  & Pick<VendorContact, 'id' | 'contactName' | 'email' | 'phone'>
);

export type VendorInfoFragment = (
  { __typename?: 'VendorInfo' }
  & Pick<VendorInfo, 'id' | 'brandName' | 'regAddress' | 'panno' | 'GSTINID' | 'state' | 'postalCode' | 'city' | 'countryCode' | 'ADHAR' | 'aboutUs' | 'staffEmail' | 'phone'>
);

export type VendorMarketingContactFragment = (
  { __typename?: 'VendorMarketingContact' }
  & Pick<VendorMarketingContact, 'id' | 'name' | 'emailAddress' | 'phone'>
);

export type GetVendorsListQueryVariables = Exact<{
  options?: Maybe<VendorListOptions>;
}>;


export type GetVendorsListQuery = (
  { __typename?: 'Query' }
  & { vendors: (
    { __typename?: 'VendorList' }
