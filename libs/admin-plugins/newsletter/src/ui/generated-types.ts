...
export type SetCustomerTovendorInput = {
  code: Scalars['String'],
...
export namespace Subscriber {
  export type Fragment = SubscriberFragment;
  export type Author = (NonNullable<SubscriberFragment['author']>);
}

export namespace Newsletter {
  export type Fragment = NewsletterFragment;
}

export namespace NewsletterQueue {
  export type Fragment = NewsletterQueueFragment;
}

export namespace NewsletterDeleteReturn {
  export type Fragment = NewsletterDeleteReturnFragment;
}

export namespace GetAllNewsletter {
  export type Variables = GetAllNewsletterQueryVariables;
  export type Query = GetAllNewsletterQuery;
  export type Newsletters = GetAllNewsletterQuery['newsletters'];
  export type Items = (NonNullable<GetAllNewsletterQuery['newsletters']['items'][0]>);
}

export namespace DeleteNewsletter {
  export type Variables = DeleteNewsletterMutationVariables;
  export type Mutation = DeleteNewsletterMutation;
  export type DeleteNewsletter = DeleteNewsletterMutation['deleteNewsletter'];
}

export namespace GetAllSubscriber {
  export type Variables = GetAllSubscriberQueryVariables;
  export type Query = GetAllSubscriberQuery;
  export type Subscribers = GetAllSubscriberQuery['subscribers'];
  export type Items = (NonNullable<GetAllSubscriberQuery['subscribers']['items'][0]>);
}

export namespace DeleteSubscriber {
  export type Variables = DeleteSubscriberMutationVariables;
  export type Mutation = DeleteSubscriberMutation;
  export type DeleteSubscriber = DeleteSubscriberMutation['deleteSubscriber'];
}

export namespace UnSubscriber {
  export type Variables = UnSubscriberMutationVariables;
  export type Mutation = UnSubscriberMutation;
  export type UnSubscriber = UnSubscriberMutation['unSubscriber'];
}

export namespace UpdateNewsletter {
  export type Variables = UpdateNewsletterMutationVariables;
  export type Mutation = UpdateNewsletterMutation;
  export type UpdateNewsletter = UpdateNewsletterMutation['updateNewsletter'];
}

export namespace UpdateNewsletterQueue {
  export type Variables = UpdateNewsletterQueueMutationVariables;
  export type Mutation = UpdateNewsletterQueueMutation;
  export type AddNewsletterQueue = UpdateNewsletterQueueMutation['addNewsletterQueue'];
}

export namespace UpdateSubscriber {
  export type Variables = UpdateSubscriberMutationVariables;
  export type Mutation = UpdateSubscriberMutation;
  export type UpdateSubscriber = UpdateSubscriberMutation['updateSubscriber'];
}

export namespace GetNewsletter {
  export type Variables = GetNewsletterQueryVariables;
  export type Query = GetNewsletterQuery;
  export type Newsletter = (NonNullable<GetNewsletterQuery['newsletter']>);
}

export namespace GetSubscriber {
  export type Variables = GetSubscriberQueryVariables;
  export type Query = GetSubscriberQuery;
  export type Subscriber = (NonNullable<GetSubscriberQuery['subscriber']>);
}

export type SubscriberFragment = (
  { __typename?: 'Subscriber' }
  & Pick<Subscriber, 'id' | 'createdAt' | 'updatedAt' | 'email' | 'subscriberToken' | 'customerFirstName' | 'customerLastName' | 'customerPhone' | 'type' | 'status' | 'tags'>
  & { author?: Maybe<(
    { __typename?: 'Customer' }
    & Pick<Customer, 'id'>
  )> }
...
export type NewsletterFragment = (
  { __typename?: 'Newsletter' }
  & Pick<Newsletter, 'id' | 'createdAt' | 'updatedAt' | 'subject' | 'template_name' | 'type' | 'customerGroupId' | 'templateContent' | 'templateCss' | 'status' | 'priority' | 'params'>
);

export type NewsletterQueueFragment = (
  { __typename?: 'NewsletterQueue' }
  & Pick<NewsletterQueue, 'id' | 'createdAt' | 'updatedAt' | 'templateId' | 'newsletter_subject' | 'newsletter_template_name' | 'newsletter_text' | 'newsletter_styles' | 'newsletter_params' | 'queue_status' | 'queue_start_at' | 'queue_finish_at'>
);

export type NewsletterDeleteReturnFragment = (
  { __typename?: 'NewsletterDeleteReturn' }
  & Pick<NewsletterDeleteReturn, 'error' | 'message'>
);

export type GetAllNewsletterQueryVariables = Exact<{
  options?: Maybe<NewsletterListOptions>;
}>;


export type GetAllNewsletterQuery = (
  { __typename?: 'Query' }
  & { newsletters: (
    { __typename?: 'NewsletterList' }
    & Pick<NewsletterList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'Newsletter' }
      & NewsletterFragment
    )> }
...
export type DeleteNewsletterMutationVariables = Exact<{
  id: Scalars['ID'];
}>;
...
export type DeleteNewsletterMutation = (
  ...
  & { deleteNewsletter: (
    { __typename?: 'NewsletterDeleteReturn' }
    & NewsletterDeleteReturnFragment
  ) }
);

export type GetAllSubscriberQueryVariables = Exact<{
  options?: Maybe<SubscriberListOptions>;
}>;


export type GetAllSubscriberQuery = (
  { __typename?: 'Query' }
  & { subscribers: (
    { __typename?: 'SubscriberList' }
    & Pick<SubscriberList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'Subscriber' }
      & SubscriberFragment
    )> }
...
export type UnSubscriberMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type UnSubscriberMutation = (
  { __typename?: 'Mutation' }
  & { unSubscriber: (
    { __typename?: 'Subscriber' }
    & SubscriberFragment
...
export type UpdateNewsletterMutationVariables = Exact<{
  input: UpdateNewsletterInput;
}>;
...
export type UpdateNewsletterQueueMutationVariables = Exact<{
  input: AddNewsletterInput;
}>;


export type UpdateNewsletterQueueMutation = (
  { __typename?: 'Mutation' }
  & { addNewsletterQueue: (
    { __typename?: 'NewsletterQueue' }
    & NewsletterQueueFragment
  ) }
);
...
export type GetNewsletterQueryVariables = Exact<{
  id: Scalars['ID'];
}>;
