...
export namespace OrdersPerMonth {
  export type Fragment = OrdersPerMonthFragment;
}

export namespace DailyOrders {
  export type Variables = DailyOrdersQueryVariables;
  export type Query = DailyOrdersQuery;
  export type DailyOrders = DailyOrdersQuery['dailyOrders'];
  export type Items = OrderFragmentFragment;
}

export namespace TestDailyOrders {
  export type Variables = TestDailyOrdersQueryVariables;
  export type Query = TestDailyOrdersQuery;
  export type TestDailyOrders = (NonNullable<TestDailyOrdersQuery['testDailyOrders']>);
  export type Items = OrdersPerMonthFragment;
}

export type CustomerFragment = (
  { __typename?: 'Customer' }
  & Pick<Customer, 'firstName' | 'lastName' | 'phoneNumber' | 'emailAddress'>
);
...
export type OrderFragmentFragment = (
  { __typename?: 'Order' }
  & Pick<Order, 'id' | 'createdAt' | 'updatedAt' | 'state' | 'active' | 'total'>
);

export type OrdersPerMonthFragment = (
  { __typename?: 'OrdersPerMonth' }
  & Pick<OrdersPerMonth, 'month' | 'totalOrders' | 'day'>
);

export type DailyOrdersQueryVariables = {
  input: DailyOrderInput;
};


export type DailyOrdersQuery = (
  { __typename?: 'Query' }
  & { dailyOrders: (
    { __typename?: 'DailyOrderList' }
    & Pick<DailyOrderList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'Order' }
...
export type TestDailyOrdersQueryVariables = {
  input: DailyOrderInput;
};


export type TestDailyOrdersQuery = (
  { __typename?: 'Query' }
  & { testDailyOrders?: Maybe<(
    { __typename?: 'DailyOrderOutput' }
    & { items: Array<(
      { __typename?: 'OrdersPerMonth' }
      & OrdersPerMonthFragment
    )> }
  )> }
);
