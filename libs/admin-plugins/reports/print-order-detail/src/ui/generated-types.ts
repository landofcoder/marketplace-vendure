...
export namespace Order {
  ...
  export type ShippingAddress = (NonNullable<OrderFragment['shippingAddress']>);
  export type BillingAddress = (NonNullable<OrderFragment['billingAddress']>);
  export type Lines = (NonNullable<OrderFragment['lines'][0]>);
  export type ProductVariant = (NonNullable<OrderFragment['lines'][0]>)['productVariant'];
  export type FeaturedAsset = (NonNullable<(NonNullable<OrderFragment['lines'][0]>)['featuredAsset']>);
  export type Adjustments = (NonNullable<OrderFragment['adjustments'][0]>);
  export type Promotions = (NonNullable<OrderFragment['promotions'][0]>);
  export type Payments = (NonNullable<(NonNullable<OrderFragment['payments']>)[0]>);
  export type Fulfillments = (NonNullable<(NonNullable<OrderFragment['fulfillments']>)[0]>);
  export type ShippingMethod = (NonNullable<OrderFragment['shippingMethod']>);
}

export namespace GetPrintOrderDetail {
  export type Variables = GetPrintOrderDetailQueryVariables;
  export type Query = GetPrintOrderDetailQuery;
  export type Order = OrderFragment;
}

export type OrderFragment = (
  { __typename?: 'Order' }
  & Pick<Order, 'id' | 'createdAt' | 'updatedAt' | 'code' | 'state' | 'active' | 'couponCodes' | 'totalQuantity' | 'subTotalBeforeTax' | 'subTotal' | 'currencyCode' | 'shipping' | 'shippingWithTax' | 'totalBeforeTax' | 'total' | 'customFields'>
  & { customer?: Maybe<(
    { __typename?: 'Customer' }
    ...
    { __typename?: 'OrderLine' }
    & Pick<OrderLine, 'id' | 'createdAt' | 'updatedAt' | 'quantity' | 'totalPrice' | 'unitPrice' | 'unitPriceWithTax'>
    & { productVariant: (
      { __typename?: 'ProductVariant' }
      & Pick<ProductVariant, 'name' | 'sku'>
    ), featuredAsset?: Maybe<(
      { __typename?: 'Asset' }
      & Pick<Asset, 'preview'>
    )> }
    ...
    { __typename?: 'Adjustment' }
    & Pick<Adjustment, 'adjustmentSource' | 'description' | 'amount'>
  )>, promotions: Array<(
    { __typename?: 'Promotion' }
    & Pick<Promotion, 'id' | 'createdAt' | 'updatedAt' | 'startsAt' | 'endsAt' | 'couponCode' | 'perCustomerUsageLimit' | 'name' | 'enabled'>
  )>, payments?: Maybe<Array<(
    { __typename?: 'Payment' }
    & Pick<Payment, 'id' | 'createdAt' | 'updatedAt' | 'method' | 'amount' | 'state' | 'transactionId' | 'errorMessage'>
...
export type GetPrintOrderDetailQueryVariables = {
  id: Scalars['ID'];
};


export type GetPrintOrderDetailQuery = (
  { __typename?: 'Query' }
  & { order?: Maybe<(
    { __typename?: 'Order' }
    & OrderFragment
