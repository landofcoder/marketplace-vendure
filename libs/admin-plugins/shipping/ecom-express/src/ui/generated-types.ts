...
export namespace EcomExpressAccount {
  export type Fragment = EcomExpressAccountFragment;
}

export namespace GetEcomExpressAccount {
  export type Variables = GetEcomExpressAccountQueryVariables;
  export type Query = GetEcomExpressAccountQuery;
  export type EcomexpressAccountConfig = (NonNullable<GetEcomExpressAccountQuery['ecomexpressAccountConfig']>);
}

export namespace UpdateEcomExpressConfig {
  export type Variables = UpdateEcomExpressConfigMutationVariables;
  export type Mutation = UpdateEcomExpressConfigMutation;
  export type UpdateEcomExpressConfig = (NonNullable<UpdateEcomExpressConfigMutation['updateEcomExpressConfig']>);
}

export type EcomExpressAccountFragment = (
  { __typename?: 'EcomExpressAccount' }
  & Pick<EcomExpressAccount, 'id' | 'username' | 'password' | 'production'>
);

export type GetEcomExpressAccountQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEcomExpressAccountQuery = (
  { __typename?: 'Query' }
  & { ecomexpressAccountConfig?: Maybe<(
    { __typename?: 'EcomExpressAccount' }
    & EcomExpressAccountFragment
  )> }
);

export type UpdateEcomExpressConfigMutationVariables = Exact<{
  input: EcomExpressInput;
}>;


export type UpdateEcomExpressConfigMutation = (
  { __typename?: 'Mutation' }
