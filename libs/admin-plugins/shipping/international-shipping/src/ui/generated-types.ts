...
export namespace ShippingCountry {
  export type Variables = ShippingCountryQueryVariables;
  export type Query = ShippingCountryQuery;
  export type ShippingCountry = (NonNullable<ShippingCountryQuery['shippingCountry']>);
}

export namespace CreateShippingCountry {
  export type Variables = CreateShippingCountryMutationVariables;
  export type Mutation = CreateShippingCountryMutation;
  export type CreateShippingCountry = (NonNullable<CreateShippingCountryMutation['createShippingCountry']>);
}

export namespace UpdateShippingCountry {
  export type Variables = UpdateShippingCountryMutationVariables;
  export type Mutation = UpdateShippingCountryMutation;
  export type UpdateShippingCountry = (NonNullable<UpdateShippingCountryMutation['updateShippingCountry']>);
}

export namespace GetShippingCountryPrice {
  export type Variables = GetShippingCountryPriceQueryVariables;
  export type Query = GetShippingCountryPriceQuery;
  export type ShippingCountries = (NonNullable<GetShippingCountryPriceQuery['shippingCountries']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetShippingCountryPriceQuery['shippingCountries']>)['items']>)[number]>;
}

export namespace DeleteShippingCountry {
  export type Variables = DeleteShippingCountryMutationVariables;
  export type Mutation = DeleteShippingCountryMutation;
  export type DeleteShippingCountry = (NonNullable<DeleteShippingCountryMutation['deleteShippingCountry']>);
}

export type ShippingCountryQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type ShippingCountryQuery = (
  { __typename?: 'Query' }
  & { shippingCountry?: Maybe<(
    { __typename?: 'ShippingCountryPrice' }
    & Pick<ShippingCountryPrice, 'id' | 'price' | 'country_code' | 'country_name'>
  )> }
);

export type CreateShippingCountryMutationVariables = Exact<{
  input: CreateShippingCountryInput;
}>;


export type CreateShippingCountryMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateShippingCountryMutationVariables = Exact<{
  input: UpdateShippingCountryInput;
}>;


export type UpdateShippingCountryMutation = (
  { __typename?: 'Mutation' }
...
export type GetShippingCountryPriceQueryVariables = Exact<{
  options?: Maybe<ShippingCountryPriceListOptions>;
}>;


export type GetShippingCountryPriceQuery = (
  { __typename?: 'Query' }
  & { shippingCountries: (
    { __typename?: 'ShippingCountryPriceList' }
    & Pick<ShippingCountryPriceList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'ShippingCountryPrice' }
      & Pick<ShippingCountryPrice, 'id' | 'price' | 'country_code' | 'country_name'>
    )> }
...
export type DeleteShippingCountryMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type DeleteShippingCountryMutation = (
  { __typename?: 'Mutation' }
