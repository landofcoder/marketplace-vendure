...
export namespace Pincode {
  export type Fragment = PincodeFragment;
}

export namespace PincodeDeleteReturn {
  export type Fragment = PincodeDeleteReturnFragment;
}

export namespace GetAllPincode {
  export type Variables = GetAllPincodeQueryVariables;
  export type Query = GetAllPincodeQuery;
  export type Pincodes = (NonNullable<GetAllPincodeQuery['pincodes']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetAllPincodeQuery['pincodes']>)['items']>)[number]>;
}

export namespace DeletePincode {
  export type Variables = DeletePincodeMutationVariables;
  export type Mutation = DeletePincodeMutation;
  export type DeletePincode = (NonNullable<DeletePincodeMutation['deletePincode']>);
}

export namespace CheckPincode {
  export type Variables = CheckPincodeQueryVariables;
  export type Query = CheckPincodeQuery;
  export type CheckPincode = (NonNullable<CheckPincodeQuery['checkPincode']>);
}

export namespace UpdatePincode {
  export type Variables = UpdatePincodeMutationVariables;
  export type Mutation = UpdatePincodeMutation;
  export type UpdatePincode = (NonNullable<UpdatePincodeMutation['updatePincode']>);
}

export namespace CreatePincode {
  export type Variables = CreatePincodeMutationVariables;
  export type Mutation = CreatePincodeMutation;
  export type CreatePincode = (NonNullable<CreatePincodeMutation['createPincode']>);
}

export namespace GetPincode {
  export type Variables = GetPincodeQueryVariables;
  export type Query = GetPincodeQuery;
  export type Pincode = (NonNullable<GetPincodeQuery['pincode']>);
}

export type PincodeFragment = (
  { __typename?: 'Pincode' }
  & Pick<Pincode, 'id' | 'createdAt' | 'updatedAt' | 'pincode' | 'state' | 'district' | 'prepaid' | 'cod' | 'pickup' | 'cash' | 'repl'>
);

export type PincodeDeleteReturnFragment = (
  { __typename?: 'PincodeDeleteReturn' }
  & Pick<PincodeDeleteReturn, 'error' | 'message'>
);

export type GetAllPincodeQueryVariables = Exact<{
  options?: Maybe<PincodeListOptions>;
}>;


export type GetAllPincodeQuery = (
  { __typename?: 'Query' }
  & { pincodes: (
    { __typename?: 'PincodeList' }
    & Pick<PincodeList, 'totalItems'>
    & { items: Array<(
      { __typename?: 'Pincode' }
      & PincodeFragment
    )> }
...
export type DeletePincodeMutationVariables = Exact<{
  id: Scalars['ID'];
}>;


export type DeletePincodeMutation = (
  { __typename?: 'Mutation' }
  & { deletePincode: (
    { __typename?: 'PincodeDeleteReturn' }
    & PincodeDeleteReturnFragment
  ) }
);

export type CheckPincodeQueryVariables = Exact<{
  pincode: CheckPincodeInput;
}>;


export type CheckPincodeQuery = (
  { __typename?: 'Query' }
  & { checkPincode: (
    { __typename?: 'Pincode' }
    & PincodeFragment
...
export type UpdatePincodeMutationVariables = Exact<{
  input: UpdatePincodeInput;
}>;


export type UpdatePincodeMutation = (
  { __typename?: 'Mutation' }
  & { updatePincode: (
    { __typename?: 'Pincode' }
    & PincodeFragment
...
export type CreatePincodeMutationVariables = Exact<{
  input: CreatePincodeInput;
}>;
...
export type GetPincodeQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type GetPincodeQuery = (
  { __typename?: 'Query' }
  & { pincode?: Maybe<(
    { __typename?: 'Pincode' }
    & PincodeFragment
