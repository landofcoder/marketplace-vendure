...
export namespace DelhiveryWarehouse {
  export type Fragment = DelhiveryWarehouseFragment;
}

export namespace DelhiveryAccount {
  export type Fragment = DelhiveryAccountFragment;
}

export namespace GetDelhiveryAccount {
  export type Variables = GetDelhiveryAccountQueryVariables;
  export type Query = GetDelhiveryAccountQuery;
  export type DelhiveryAccount = (NonNullable<GetDelhiveryAccountQuery['delhiveryAccount']>);
}

export namespace UpdateDelhiveryAccount {
  export type Variables = UpdateDelhiveryAccountMutationVariables;
  export type Mutation = UpdateDelhiveryAccountMutation;
  export type UpdateDelhiveryAccount = (NonNullable<UpdateDelhiveryAccountMutation['updateDelhiveryAccount']>);
}

export namespace UpdateDelhiveryWarehouse {
  export type Variables = UpdateDelhiveryWarehouseMutationVariables;
  export type Mutation = UpdateDelhiveryWarehouseMutation;
  export type UpdateDelhiveryWarehouse = (NonNullable<UpdateDelhiveryWarehouseMutation['updateDelhiveryWarehouse']>);
}

export namespace CreateDelhiveryWarehouse {
  export type Variables = CreateDelhiveryWarehouseMutationVariables;
  export type Mutation = CreateDelhiveryWarehouseMutation;
  export type CreateDelhiveryWarehouse = (NonNullable<CreateDelhiveryWarehouseMutation['createDelhiveryWarehouse']>);
}

export namespace GetDelhiveryWarehouse {
  export type Variables = GetDelhiveryWarehouseQueryVariables;
  export type Query = GetDelhiveryWarehouseQuery;
  export type DelhiveryWarehouse = (NonNullable<GetDelhiveryWarehouseQuery['delhiveryWarehouse']>);
}

export namespace GetDelhiveryWarehouseByChannelId {
  export type Variables = GetDelhiveryWarehouseByChannelIdQueryVariables;
  export type Query = GetDelhiveryWarehouseByChannelIdQuery;
  export type DelhiveryWarehouseByChannelId = (NonNullable<GetDelhiveryWarehouseByChannelIdQuery['delhiveryWarehouseByChannelId']>);
}

export namespace GetDelhiveryWarehouseByPickupName {
  export type Variables = GetDelhiveryWarehouseByPickupNameQueryVariables;
  export type Query = GetDelhiveryWarehouseByPickupNameQuery;
  export type DelhiveryWarehouseByPickupName = (NonNullable<GetDelhiveryWarehouseByPickupNameQuery['delhiveryWarehouseByPickupName']>);
}

export type DelhiveryWarehouseFragment = (
  { __typename?: 'DelhiveryWarehouse' }
  & Pick<DelhiveryWarehouse, 'id' | 'createdAt' | 'updatedAt' | 'pickup_name' | 'city' | 'pincode' | 'state' | 'address' | 'country' | 'contact_person_name' | 'contact_person_email' | 'contact_person_phone' | 'return_address' | 'return_pincode' | 'return_city' | 'return_state' | 'return_country' | 'from_working_hours' | 'to_working_hours' | 'day_working_hours' | 'preferred_pickup_slots' | 'channelId'>
);

export type DelhiveryAccountFragment = (
  { __typename?: 'DelhiveryAccount' }
  & Pick<DelhiveryAccount, 'id' | 'client_name' | 'user_name' | 'api_key' | 'shipping_mode' | 'hand_fee'>
);

export type GetDelhiveryAccountQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDelhiveryAccountQuery = (
  { __typename?: 'Query' }
  & { delhiveryAccount?: Maybe<(
    { __typename?: 'DelhiveryAccount' }
    & DelhiveryAccountFragment
  )> }
);

export type UpdateDelhiveryAccountMutationVariables = Exact<{
  input: UpdateDelhiveryAccountInput;
}>;


export type UpdateDelhiveryAccountMutation = (
  { __typename?: 'Mutation' }
...
export type UpdateDelhiveryWarehouseMutationVariables = Exact<{
  input: UpdateDelhiveryWarehouseInput;
}>;


export type UpdateDelhiveryWarehouseMutation = (
  { __typename?: 'Mutation' }
  & { updateDelhiveryWarehouse: (
    { __typename?: 'DelhiveryWarehouse' }
    & DelhiveryWarehouseFragment
  ) }
);

export type CreateDelhiveryWarehouseMutationVariables = Exact<{
  input: CreateDelhiveryWarehouseInput;
  countryName: Scalars['String'];
}>;


export type CreateDelhiveryWarehouseMutation = (
  { __typename?: 'Mutation' }
...
export type GetDelhiveryWarehouseQueryVariables = Exact<{
  id: Scalars['ID'];
}>;


export type GetDelhiveryWarehouseQuery = (
  { __typename?: 'Query' }
  & { delhiveryWarehouse?: Maybe<(
    { __typename?: 'DelhiveryWarehouse' }
    & DelhiveryWarehouseFragment
  )> }
);

export type GetDelhiveryWarehouseByChannelIdQueryVariables = Exact<{
  input: DelhiveryWarehouseByChannelId;
}>;


export type GetDelhiveryWarehouseByChannelIdQuery = (
  { __typename?: 'Query' }
  & { delhiveryWarehouseByChannelId?: Maybe<(
    { __typename?: 'DelhiveryWarehouse' }
    & DelhiveryWarehouseFragment
  )> }
);

export type GetDelhiveryWarehouseByPickupNameQueryVariables = Exact<{
  input: DelhiveryWarehouseByPickupName;
}>;


export type GetDelhiveryWarehouseByPickupNameQuery = (
  { __typename?: 'Query' }
  & { delhiveryWarehouseByPickupName?: Maybe<(
    { __typename?: 'DelhiveryWarehouse' }
    & DelhiveryWarehouseFragment
  )> }
);
