...
export type QueryProductGirdArgs = {
  options?: Maybe<ProductListOptions>;
};
...
export namespace GetProductListCustomize {
  ...
  export type ProductGird = GetProductListCustomizeQuery['productGrid'];
  export type Items = (NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>);
  export type Translations = (NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['translations'][0]>);
  export type FeaturedAsset = (NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['featuredAsset']>);
  export type FacetValues = (NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['facetValues'][0]>);
  export type Variants = (NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>);
  export type _Translations = (NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['translations'][0]>);
  export type TaxCategory = (NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['taxCategory'];
  export type _FacetValues = (NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['facetValues'][0]>);
  export type _FeaturedAsset = (NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['featuredAsset']>);
  export type Assets = (NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['assets'][0]>);
  export type CustomFields = (NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']['items'][0]>)['variants'][0]>)['customFields']>);
}
