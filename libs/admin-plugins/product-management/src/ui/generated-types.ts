...
export type Mutation = {
  ...
  setProductStatus?: Maybe<Product>;
...
export type OrderFilterCondition = {
  orderPlacedAt?: Maybe<NumberRange>;
};
...
export type ProductVariantFilterParameter = {
  ...
  MRPPrice?: Maybe<NumberOperators>;
};
...
export namespace SeoConfig {
  export type Fragment = SeoConfigFragment;
}

export namespace GetSeoConfig {
  export type Variables = GetSeoConfigQueryVariables;
  export type Query = GetSeoConfigQuery;
  export type GetSeoConfig = (NonNullable<GetSeoConfigQuery['getSEOConfig']>);
}

export namespace UpdateSeoConfig {
  export type Variables = UpdateSeoConfigMutationVariables;
  export type Mutation = UpdateSeoConfigMutation;
  export type UpdateSeoConfig = (NonNullable<UpdateSeoConfigMutation['updateSEOConfig']>);
}

export namespace GetProductListCustomize {
  export type Variables = GetProductListCustomizeQueryVariables;
  export type Query = GetProductListCustomizeQuery;
  export type ProductGrid = (NonNullable<GetProductListCustomizeQuery['productGrid']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>;
  export type Translations = NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['translations']>)[number]>;
  export type FeaturedAsset = (NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['featuredAsset']>);
  export type FacetValues = NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['facetValues']>)[number]>;
  export type Channels = NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['channels']>)[number]>;
  export type CustomFields = (NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['customFields']>);
  export type Variants = NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>;
  export type _Translations = NonNullable<(NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['translations']>)[number]>;
  export type TaxCategory = (NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['taxCategory']>);
  export type _FacetValues = NonNullable<(NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['facetValues']>)[number]>;
  export type _FeaturedAsset = (NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['featuredAsset']>);
  export type Assets = NonNullable<(NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['assets']>)[number]>;
  export type _CustomFields = (NonNullable<NonNullable<(NonNullable<NonNullable<(NonNullable<(NonNullable<GetProductListCustomizeQuery['productGrid']>)['items']>)[number]>['variants']>)[number]>['customFields']>);
}

export namespace SetProductStatus {
  export type Variables = SetProductStatusMutationVariables;
  export type Mutation = SetProductStatusMutation;
  export type SetProductStatus = (NonNullable<SetProductStatusMutation['setProductStatus']>);
}

export type SeoConfigFragment = (
  { __typename?: 'SEOConfig' }
  & Pick<SeoConfig, 'id' | 'title' | 'titleTemplate' | 'description' | 'url' | 'site_name'>
);

export type GetSeoConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSeoConfigQuery = (
  { __typename?: 'Query' }
  & { getSEOConfig?: Maybe<(
    { __typename?: 'SEOConfig' }
    & SeoConfigFragment
...
export type UpdateSeoConfigMutationVariables = Exact<{
  input: SeoConfigInput;
}>;


export type UpdateSeoConfigMutation = (
  { __typename?: 'Mutation' }
  & { updateSEOConfig: (
    { __typename?: 'SEOConfig' }
    & SeoConfigFragment
...
export type GetProductListCustomizeQueryVariables = Exact<{
  options?: Maybe<ProductListOptions>;
}>;


export type GetProductListCustomizeQuery = (
  { __typename?: 'Query' }
  & { productGrid: (
    { __typename?: 'ProductList' }
    ...
    & { items: Array<(
      { __typename?: 'Product' }
      & Pick<Product, 'id' | 'enabled' | 'languageCode'>
      & { translations: Array<(
        { __typename?: 'ProductTranslation' }
        & Pick<ProductTranslation, 'id' | 'name' | 'slug' | 'description' | 'languageCode'>
      )>, featuredAsset?: Maybe<(
        { __typename?: 'Asset' }
        ...
        { __typename?: 'ProductCustomFields' }
        & Pick<ProductCustomFields, 'status'>
      )>, variants: Array<(
        { __typename?: 'ProductVariant' }
        & Pick<ProductVariant, 'id' | 'enabled' | 'languageCode' | 'sku' | 'price' | 'trackInventory' | 'stockOnHand'>
        & { translations: Array<(
          { __typename?: 'ProductVariantTranslation' }
          & Pick<ProductVariantTranslation, 'id' | 'name' | 'languageCode'>
        )>, taxCategory: (
          { __typename?: 'TaxCategory' }
          ...
          { __typename?: 'Asset' }
          & Pick<Asset, 'id' | 'name' | 'source'>
        )>, customFields?: Maybe<(
          { __typename?: 'ProductVariantCustomFields' }
          & Pick<ProductVariantCustomFields, 'shippingPrice' | 'shippingBusinessPrice'>
        )> }
      )> }
    )> }
  ) }
