...
export namespace ProductRecommendations {
  export type Variables = ProductRecommendationsQueryVariables;
  export type Query = ProductRecommendationsQuery;
  export type ProductRecommendations = NonNullable<(NonNullable<ProductRecommendationsQuery['productRecommendations']>)[number]>;
  export type Recommendation = (NonNullable<NonNullable<(NonNullable<ProductRecommendationsQuery['productRecommendations']>)[number]>['recommendation']>);
}

export namespace UpdateRecommendations {
  export type Variables = UpdateRecommendationsMutationVariables;
  export type Mutation = UpdateRecommendationsMutation;
}
...
export type ProductRecommendationsQuery = (
  ...
  & { productRecommendations: Array<(
    { __typename?: 'ProductRecommendation' }
    & Pick<ProductRecommendation, 'type'>
    & { recommendation: (
      { __typename?: 'Product' }
...
export type UpdateRecommendationsMutationVariables = Exact<{
  productId: Scalars['ID'];
  crossSellIds: Array<Scalars['ID']>;
  upSellIds: Array<Scalars['ID']>;
}>;


export type UpdateRecommendationsMutation = (
  { __typename?: 'Mutation' }
  & Pick<Mutation, 'updateCrossSellingProducts' | 'updateUpSellingProducts'>
);
