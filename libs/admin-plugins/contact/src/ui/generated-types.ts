...
export type Query = {
  ...
  domesticOrders: OrderList,
  internationalOrders: OrderList,
...
export type QueryDomesticOrdersArgs = {
  options?: Maybe<OrderListOptions>
};


export type QueryInternationalOrdersArgs = {
  options?: Maybe<OrderListOptions>
};
...
export namespace Contact {
  export type Fragment = ContactFragment;
}

export namespace ContactDeleteReturn {
  export type Fragment = ContactDeleteReturnFragment;
}

export namespace GetAllContact {
  export type Variables = GetAllContactQueryVariables;
  export type Query = GetAllContactQuery;
  export type Contacts = GetAllContactQuery['contacts'];
  export type Items = (NonNullable<GetAllContactQuery['contacts']['items'][0]>);
}

export namespace DeleteContact {
  export type Variables = DeleteContactMutationVariables;
  export type Mutation = DeleteContactMutation;
  export type DeleteContact = DeleteContactMutation['deleteContact'];
}

export namespace UpdateContact {
  export type Variables = UpdateContactMutationVariables;
  export type Mutation = UpdateContactMutation;
  export type UpdateContact = UpdateContactMutation['updateContact'];
}

export namespace GetContact {
  export type Variables = GetContactQueryVariables;
  export type Query = GetContactQuery;
  export type Contact = (NonNullable<GetContactQuery['contact']>);
}

export type ContactFragment = (
  { __typename?: 'Contact' }
  & Pick<Contact, 'channelId' | 'id' | 'createdAt' | 'updatedAt' | 'deletedAt' | 'sentAt' | 'subject' | 'message' | 'body' | 'authorEmail' | 'authorPhone' | 'authorName' | 'authorLocation' | 'authorIp' | 'adminUserId' | 'error' | 'tags' | 'adminNote' | 'state' | 'response' | 'responseCreatedAt'>
);

export type ContactDeleteReturnFragment = (
  { __typename?: 'ContactDeleteReturn' }
  & Pick<ContactDeleteReturn, 'error' | 'message'>
);
