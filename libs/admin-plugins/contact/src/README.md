...
You should then be able to log into the Admin UI (http://localhost:3000/admin) and see the new "Contacts" menu item on the left. Clicking this takes you to a brand new extension module listing all product reviews. You can approve the review that was just submitted.
